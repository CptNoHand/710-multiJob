...
Config.usingQBmenu = true -- If you want to use the QB Menu, set this to true.
...
Cofnig.Open = 'key' -- how do you want to open the multijob menu | options allowed: 'command', 'key'
